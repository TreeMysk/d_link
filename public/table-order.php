...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Užsakymų sąrašai</li>
		</ol><!--breadcrum end-->
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">UŽSAKYMŲ SĄRAŠAI</div>
						</div>
					...
					<div class="table-responsive"> 
						...
						<br>
						<p align="center">nėra užsakymų...</p>
						<br>
					</div>
				</div>
							...
							<tbody>
								<tr>
									...
									<td>
										...
										<span class="badge badge-success">APDOROTAS</span>
										<?php } else if ($data['status'] == '2') { ?>
										<span class="badge">&nbsp;ATŠAUKTAS&nbsp;</span>
										<?php } else { ?>
										<span class="badge badge-error">&nbsp;&nbsp;&nbsp;LAUKIAMAS&nbsp;&nbsp;&nbsp;</span>
										<?php } ?>
									</td>
									<td>

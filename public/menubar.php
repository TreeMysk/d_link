...
<title>D-Link administracija</title>
				...
				<div class="dropdown-menu dropdown-menu-right pmd-card pmd-card-default pmd-z-depth" role="menu">
					...
					<div class="pmd-card-title">
						<div class="media-body media-middle">
							<a href="#" class="pull-right"><?php echo $total_pending; ?> Laukiantis užsakymas</a>
							<h3 class="pmd-card-title-text">Laukiantis užsakymas</h3>
						</div>
					</div>
					...
					<?php if ($total_pending == '0') { ?>
						<li class="list-group-item">
							<p class="notification-blank">
								...
								<span>Neturi laukiančio užsakymo...</span>
							</p>
						</li>
					...
					<?php } ?>
						<li class="list-group-item unread">
							<a href="manage-order.php">
								<div class="media-body">
									<div align="center">Peržiūrėti visus</div>
								</div>
							</a>
						</li>
	...
	<ul class="nav pmd-sidebar-nav">
		...
		<li class="dropdown pmd-dropdown pmd-user-info visible-xs visible-md visible-sm visible-lg">
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" aria-expandedhref="javascript:void(0);">
				...
				<div class="media-body media-middle">Sveiki, <?php echo $data['username'] ?></div>
				<div class="media-right media-middle"><i class="dic-more-vert dic"></i></div>
			</a>
			<ul class="dropdown-menu">
				<li><a href="edit-profile.php?id=<?php echo $data['id']; ?>">Profilis</a></li>
		...
		<li> 
			<a class="pmd-ripple-effect" href="manage-order.php">	
				...
				<span class="media-body">Užsakymų sąrašai</span>
			</a>
		</li>
		...
		<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				...
				<span class="media-body">Kategorija</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				<li><a href="add-category.php">Papildyti</a></li>
				<li><a href="manage-category.php">Kategorijų sąrašai</a></li>
		...
		<li class="dropdown pmd-dropdown"> 
			<a aria-expanded="false" data-toggle="dropdown" class="btn-user dropdown-toggle media" data-sidebar="true" href="javascript:void(0);">	
				...
				<span class="media-body">Produktai</span>
				<div class="media-right media-bottom"><i class="dic-more-vert dic"></i></div>
			</a> 
			<ul class="dropdown-menu">
				<li><a href="add-product.php">Papildyti</a></li>
				<li><a href="manage-product.php">Produktų sąrašai</a></li>
		...
		<li> 
			<a class="pmd-ripple-effect" href="settings.php">	
				...
				<span class="media-body">Nustatymai</span>
			</a> 
		</li>
		...
		<li> 
			<a class="pmd-ripple-effect" href="logout.php">	
				...
				<span class="media-body">Atsijungti</span>
			</a> 
		</li>

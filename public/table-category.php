...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Tvarkyti kategoriją</li>
		</ol><!--breadcrum end-->
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
							<div class="lead">TVARKYTI KATEGORIJĄ</div>
						</div>
						<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 pull-right">
							<div class="form-group pmd-textfield">
								<input type="text" name="keyword" class="form-control" placeholder="Ieškoti...">
							</div>
						</div>
					</div>
						...
						<table cellspacing="0" cellpadding="0" class="table pmd-table table-hover" id="table-propeller">
							<thead>
								<tr>
									...
									<th>Kategorijos nuotraukos</th>
									<th width="15%">Veiksmas</th>
								</tr>
							</thead>

						</table>
						<p align="center">nėra duomenų...</p>
							...
							<tbody>
								<tr>
									...
									<td>
									    ...
									    <a href="delete-category.php?id=<?php echo $data['category_id'];?>" onclick="return confirm('Ar tikrai norite ištrinti šią kategoriją?')" >

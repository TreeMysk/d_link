...
<div id="content" class="pmd-content content-area dashboard">
	...
	<div class="container-fluid full-width-container">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">Redaguoti produktą</li>
		</ol>
		<!--breadcrum end-->
				...
				<div class="pmd-card-body">
					...
					<div class="group-fields clearfix row">
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="lead">REDAGUOTI PRODUKTĄ</div>
						</div>
					</div>
					...
					<div class="group-fields clearfix row">
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_name" class="control-label">Produkto pavadinimas *</label>
								<input type="text" name="product_name" id="product_name" class="form-control" placeholder="Produkto pavadinimas" value="<?php echo $row['product_name'];?>" required>
							</div>
						</div>

						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_price" class="control-label">Produkto nuotraukos ( <?php echo $row_currency["currency_code"]; ?> ) *</label>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="product_quantity" class="control-label">Produkto kiekis *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">       
								...
								<select class="select-simple form-control pmd-select2" name="product_status">
									<option <?php if($row['product_status'] == 'Available'){ echo 'selected';} ?> value="Available">TURIMAS</option>
									<option <?php if($row['product_status'] == 'Sold Out'){echo 'selected';} ?> value="Sold Out">IŠPARDUOTA</option>
								</select>
							</div>
						</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="form-group pmd-textfield">
								<label for="regular1" class="control-label">Nuotraukos ( jpg / png ) *</label>
						...
						<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="form-group pmd-textfield">
								<label class="control-label">Produkto aprašymas *</label>

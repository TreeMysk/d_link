        ...
        <div class="login-card">
            <form method="POST">  
                <div class="pmd-card-title card-header-border text-center">
                    <div class="loginlogo">
                        <img src="assets/images/d-link-logo.png" alt="Logo">
                    </div>
                    <div class="lead">D-Link administracijos prisijungimas</div>
                </div>
                
                <div class="pmd-card-body">
                    <?php echo isset($error['failed']) ? $error['failed'] : '';?>
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        <label for="inputError1" class="control-label pmd-input-group-label">Vartotojo vardas</label>
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        <label for="inputError1" class="control-label pmd-input-group-label">Slaptažodžiai</label>
                        <div class="input-group">
                ...
                <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
                    ...
                    <button type="submit" name="btnLogin" class="btn pmd-ripple-effect btn-danger btn-block">Prisijunk</button>
                    <br>
                    <br>
                    <span class="pmd-card-subtitle-text">Linas Miskelis &copy; <span class="auto-update-year"></span>Praktika</span>
